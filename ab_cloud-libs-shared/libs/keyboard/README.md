...
```bash
git clone https://github.com/Helium314/HeliBoard ~/git/cloud-android/ac_keyboard-heliboard
cd ~/git/cloud-android/aa_cloud-superapp
...
The sibling clone (`~/git/cloud-android/ac_keyboard-heliboard/`) is gitignored — the
