{
  description = "Cloud Media Center — Nix devShell wrapping the Android Gradle build for the ReFra-fork gallery APK. gradle + AGP + Android SDK + JDK 17. All toolchain pinned; same input → same APK. No Node/Cordova (pure Kotlin/Compose fork, unlike the Acode fork in ac_cloud-ide).";
  ...
  outputs = { self, nixpkgs, flake-utils, ... }:
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in {
        ...
        # is a stub, same honest-placeholder pattern as ac_cloud-ide.
