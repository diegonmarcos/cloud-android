...
import com.diegonmarcos.mediacenter.benchmark.BenchmarkUtils.TAG
 ...
 *
 * Run with:
 *   ./gradlew :app:connectedAndroidTest -Pandroid.testInstrumentationRunnerArguments.class=com.diegonmarcos.mediacenter.benchmark.MediaStoreQueryBenchmark
 *
 * View results with:
