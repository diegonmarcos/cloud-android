...
import com.diegonmarcos.mediacenter.core.Settings.Misc.rememberShowFavoriteButton
...
import com.diegonmarcos.mediacenter.feature_node.presentation.mediaview.components.actionbuttons.CopyToClipboardButton
import com.diegonmarcos.mediacenter.feature_node.presentation.mediaview.components.actionbuttons.DownloadButton
import com.diegonmarcos.mediacenter.feature_node.presentation.mediaview.components.actionbuttons.EditButton
import com.diegonmarcos.mediacenter.feature_node.presentation.mediaview.components.actionbuttons.FavoriteButton
import com.diegonmarcos.mediacenter.feature_node.presentation.mediaview.components.actionbuttons.MediaViewButton
import com.diegonmarcos.mediacenter.feature_node.presentation.mediaview.components.actionbuttons.OpenAsButton
import com.diegonmarcos.mediacenter.feature_node.presentation.mediaview.components.actionbuttons.PrivateFolderDeleteButton
import com.diegonmarcos.mediacenter.feature_node.presentation.mediaview.components.actionbuttons.RestoreButton
import com.diegonmarcos.mediacenter.feature_node.presentation.mediaview.components.actionbuttons.ShareButton
import com.diegonmarcos.mediacenter.feature_node.presentation.mediaview.components.actionbuttons.TrashButton
...
fun <T : Media> MediaViewQuickBottomBar(
    ...
    val isDarkTheme = com.diegonmarcos.mediacenter.ui.theme.isDarkTheme()
    ...
    if (currentMedia != null) {
        if (currentMedia.isTrashed) {
            ...
            if (currentMedia.isRaw && !currentMedia.isEncrypted && !readOnly &&
                com.diegonmarcos.mediacenter.core.decoder.NativeRawDecoder.isAvailable
            ) {
                com.diegonmarcos.mediacenter.feature_node.presentation.mediaview.components.rawdevelop.RawDevelopButton(
                    media = currentMedia,
                    enabled = enabled,
                    followTheme = followTheme
                )
