...
/**
 * Stable, collision-resistant id for a cloud media item, used as [com.diegonmarcos.mediacenter.feature_node.domain.model.Media.id].
 *
...
/**
 * Stable id for a cloud ALBUM, used as [com.diegonmarcos.mediacenter.feature_node.domain.model.Album.id].
 *
