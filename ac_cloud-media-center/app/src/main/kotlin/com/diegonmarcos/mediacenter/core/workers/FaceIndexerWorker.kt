...
import com.diegonmarcos.mediacenter.core.ml.DetectedFaceBox
import com.diegonmarcos.mediacenter.core.ml.FaceHelper
...
class FaceIndexerWorker @AssistedInject constructor(
    ...
    private suspend fun assignCluster(
        ...
        item: com.diegonmarcos.mediacenter.feature_node.domain.model.Media.UriMedia,
