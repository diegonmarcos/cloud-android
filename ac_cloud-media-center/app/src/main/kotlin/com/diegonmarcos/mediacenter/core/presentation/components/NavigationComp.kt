...
import com.diegonmarcos.mediacenter.feature_node.domain.model.AlbumSectionWithAlbums
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.launch
import com.diegonmarcos.mediacenter.core.Constants.Animation.navigateInAnimation
import com.diegonmarcos.mediacenter.core.Constants.Animation.navigateUpAnimation
import com.diegonmarcos.mediacenter.core.Constants.Target.TARGET_FAVORITES
import com.diegonmarcos.mediacenter.core.Constants.Target.TARGET_TRASH
...
import com.diegonmarcos.mediacenter.core.Settings.Misc.rememberForcedLastScreen
import com.diegonmarcos.mediacenter.core.Settings.Misc.rememberLastScreen
import com.diegonmarcos.mediacenter.core.Settings
import com.diegonmarcos.mediacenter.core.Settings.Misc.rememberTimelineGroupByMonth
import com.diegonmarcos.mediacenter.core.Settings.Misc.rememberTimelineGroupByYear
import com.diegonmarcos.mediacenter.core.navigate
import com.diegonmarcos.mediacenter.core.presentation.components.util.OnLifecycleEvent
import com.diegonmarcos.mediacenter.core.presentation.components.util.permissionGranted
import com.diegonmarcos.mediacenter.core.presentation.vm.NavigationViewModel
...
import com.diegonmarcos.mediacenter.feature_node.presentation.albums.AlbumGroupViewScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.albums.EditGroupScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.albums.AlbumsScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.albums.AlbumsViewModel
import com.diegonmarcos.mediacenter.feature_node.presentation.albumtimeline.AlbumTimelineScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.classifier.AddCategoryScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.classifier.CategoriesSettingsScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.classifier.CategoryEditorScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.classifier.EditCategoryScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.classifier.CategoriesScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.classifier.CategoriesViewModel
import com.diegonmarcos.mediacenter.feature_node.presentation.location.LocationsScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.classifier.CategoryViewModel
import com.diegonmarcos.mediacenter.feature_node.presentation.classifier.CategoryViewScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.collection.CollectionViewModel
import com.diegonmarcos.mediacenter.feature_node.presentation.collection.CollectionAlbumSelectorScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.collection.CollectionViewScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.dateformat.DateFormatScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.exif.MetadataViewScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.exif.MetadataViewViewModel
import com.diegonmarcos.mediacenter.feature_node.presentation.favorites.FavoriteScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.help.HelpScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.help.TutorialCategoryScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.help.TutorialDetailScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.help.WhatsNewScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.ignored.IgnoredScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.library.LibraryScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.location.LocationTimelineScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.location.LocationsViewModel
...
import com.diegonmarcos.mediacenter.feature_node.presentation.search.SearchScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.search.SearchViewModel
import com.diegonmarcos.mediacenter.feature_node.presentation.settings.SettingsScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.settings.subsettings.ColorPaletteScreen

import com.diegonmarcos.mediacenter.feature_node.presentation.settings.subsettings.SettingsGeneralScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.settings.subsettings.SettingsMediaViewerScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.settings.subsettings.SettingsNavigationScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.settings.subsettings.SettingsSelectionActionsScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.settings.subsettings.SlideshowSettingsScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.settings.subsettings.SettingsTimelineAlbumsScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.settings.subsettings.EditBackupsViewerScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.settings.subsettings.AIModelsManagerScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.settings.subsettings.SettingsSecurityScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.settings.subsettings.SettingsBackupScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.settings.subsettings.SettingsBackupExportScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.settings.subsettings.SettingsBackupImportScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.settings.subsettings.SettingsSmartFeaturesScreen
import com.diegonmarcos.mediacenter.cloud.core.ProviderType
import com.diegonmarcos.mediacenter.cloud.ui.CloudAccountsScreen
import com.diegonmarcos.mediacenter.cloud.ui.CloudAddServerScreen
import com.diegonmarcos.mediacenter.cloud.ui.CloudTimelineScreen
import com.diegonmarcos.mediacenter.cloud.ui.CloudUploadSettingsScreen
import com.diegonmarcos.mediacenter.cloud.ui.archive.CloudArchiveScreen
import com.diegonmarcos.mediacenter.cloud.ui.archive.CloudArchiveViewModel
import com.diegonmarcos.mediacenter.cloud.ui.backup.BackupOptionsScreen
import com.diegonmarcos.mediacenter.cloud.ui.backup.CloudBackupAndSyncScreen
import com.diegonmarcos.mediacenter.cloud.ui.backup.CloudBackupDashboardScreen
import com.diegonmarcos.mediacenter.cloud.ui.backup.CloudBackupScreen
import com.diegonmarcos.mediacenter.cloud.ui.backup.UploadDetailsScreen
import com.diegonmarcos.mediacenter.cloud.ui.destinations.CloudDestinationsScreen
import com.diegonmarcos.mediacenter.cloud.ui.memories.MemoriesScreen
import com.diegonmarcos.mediacenter.cloud.ui.people.PeopleListScreen
import com.diegonmarcos.mediacenter.cloud.ui.people.PersonDetailScreen
import com.diegonmarcos.mediacenter.cloud.ui.people.PersonDetailViewModel
import com.diegonmarcos.mediacenter.cloud.ui.sharing.SharedLinksScreen
import com.diegonmarcos.mediacenter.cloud.ui.settings.CloudAdvancedSettingsScreen
import com.diegonmarcos.mediacenter.cloud.ui.settings.CloudNetworkingScreen
import com.diegonmarcos.mediacenter.cloud.ui.settings.CloudNotificationSettingsScreen
import com.diegonmarcos.mediacenter.cloud.ui.offline.OfflineModeScreen
import com.diegonmarcos.mediacenter.cloud.ui.settings.CloudProviderSettingsScreen
import com.diegonmarcos.mediacenter.cloud.ui.settings.CloudViewerSettingsScreen
import com.diegonmarcos.mediacenter.cloud.ui.space.FreeUpSpaceScreen
import com.diegonmarcos.mediacenter.cloud.ui.sync.SyncStatusScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.setup.SetupScreen

import com.diegonmarcos.mediacenter.feature_node.presentation.storycards.StoryCardsSettingsScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.storycards.StoryCardsViewModel
import com.diegonmarcos.mediacenter.feature_node.presentation.storycards.StoryViewerScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.timeline.TimelineScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.trashed.TrashedGridScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.util.Screen
import com.diegonmarcos.mediacenter.feature_node.presentation.privatefolder.PrivateFolderScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.privatefolder.PrivateFolderSecuritySetupScreen
import com.diegonmarcos.mediacenter.feature_node.presentation.privatefolder.PrivateFolderViewModel
import com.diegonmarcos.mediacenter.feature_node.presentation.vault.VaultScreen
