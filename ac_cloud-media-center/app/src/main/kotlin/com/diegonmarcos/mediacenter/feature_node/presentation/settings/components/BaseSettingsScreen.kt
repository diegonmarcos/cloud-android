...
import com.diegonmarcos.mediacenter.feature_node.presentation.help.data.SettingsSearchRegistry
...
fun BaseSettingsScreen(
    ...
    val firstActionableIndex = settingsList.indexOfFirst { item ->
        item.enabled && !item.isHeader && when (item.type) {
            com.diegonmarcos.mediacenter.core.PreferenceType.Seek -> item.onSeek != null
            com.diegonmarcos.mediacenter.core.PreferenceType.Switch -> item.onCheck != null || item.onClick != null
