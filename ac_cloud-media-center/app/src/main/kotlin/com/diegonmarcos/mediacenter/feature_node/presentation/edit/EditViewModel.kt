package com.diegonmarcos.mediacenter.feature_node.presentation.edit
...
import com.diegonmarcos.mediacenter.core.ml.CutoutHelper
import com.diegonmarcos.mediacenter.core.ml.ModelGroup
import com.diegonmarcos.mediacenter.feature_node.presentation.edit.adjustments.Cutout
import com.diegonmarcos.mediacenter.feature_node.presentation.edit.adjustments.FlattenBackground
import com.diegonmarcos.mediacenter.feature_node.presentation.mediaview.components.media.CutoutState
import com.diegonmarcos.mediacenter.feature_node.presentation.mediaview.components.media.ZoomablePagerImagePointTool
...
import com.diegonmarcos.mediacenter.feature_node.presentation.edit.bake.EditReplay
import com.diegonmarcos.mediacenter.feature_node.presentation.edit.bake.NativeHeifEncoder
import com.diegonmarcos.mediacenter.feature_node.presentation.edit.bake.NativeImageEncoder
import com.diegonmarcos.mediacenter.feature_node.presentation.edit.bake.TiledBakeEngine
import com.diegonmarcos.mediacenter.feature_node.presentation.edit.components.develop.RawSaveFormat
import com.diegonmarcos.mediacenter.core.util.ext.saveImageStreaming
import com.diegonmarcos.mediacenter.core.util.ext.overrideImageStreaming
...
import com.diegonmarcos.mediacenter.core.decoder.NativeRawDecoder
import com.diegonmarcos.mediacenter.core.decoder.RawDevelopParams
import com.diegonmarcos.mediacenter.core.decoder.RawDevelopStore
import com.diegonmarcos.mediacenter.core.decoder.RawOrientation
import com.diegonmarcos.mediacenter.core.decoder.RawRegionDecoder
import com.diegonmarcos.mediacenter.core.decoder.RawThumbnailCache
import com.diegonmarcos.mediacenter.core.decoder.format.ImageReencoder
import com.diegonmarcos.mediacenter.core.decoder.format.SourceQualityProbe
...
import com.diegonmarcos.mediacenter.feature_node.domain.util.isRaw
import com.diegonmarcos.mediacenter.feature_node.domain.model.editor.Adjustment
import com.diegonmarcos.mediacenter.feature_node.domain.model.editor.DrawMode
import com.diegonmarcos.mediacenter.feature_node.domain.model.editor.DrawType
...
import com.diegonmarcos.mediacenter.feature_node.domain.model.editor.SuggestionPreset
...
import com.diegonmarcos.mediacenter.feature_node.presentation.edit.adjustments.Flip
import com.diegonmarcos.mediacenter.feature_node.presentation.edit.adjustments.Markup
import com.diegonmarcos.mediacenter.feature_node.presentation.edit.adjustments.MatrixAdjustment
import com.diegonmarcos.mediacenter.feature_node.presentation.edit.adjustments.Rotate90CW
import com.diegonmarcos.mediacenter.feature_node.presentation.edit.adjustments.varfilter.Rotate
...
class EditViewModel @Inject constructor(
    ...
    private val modelManager: com.diegonmarcos.mediacenter.core.ml.ModelManager,
) : ViewModel() {
    ...
    val faceDetectAvailable: Boolean
        get() = modelManager.isReady(com.diegonmarcos.mediacenter.core.ml.ModelGroup.FACE_DETECT)
    ...
    fun detectFacesForMarkup() {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            ...
            val helper = com.diegonmarcos.mediacenter.core.ml.FaceHelper(modelManager)
            try {
