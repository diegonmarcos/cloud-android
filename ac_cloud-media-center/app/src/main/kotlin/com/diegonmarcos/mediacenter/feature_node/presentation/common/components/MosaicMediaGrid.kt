...
package com.diegonmarcos.mediacenter.feature_node.presentation.common.components
...
import com.diegonmarcos.mediacenter.core.presentation.components.LoadingMedia
import com.diegonmarcos.mediacenter.core.presentation.components.MediaItemHeader
...
import com.diegonmarcos.mediacenter.feature_node.domain.model.MosaicTilePattern
import com.diegonmarcos.mediacenter.feature_node.domain.model.isBigHeaderKey
import com.diegonmarcos.mediacenter.feature_node.domain.model.isHeaderKey
import com.diegonmarcos.mediacenter.feature_node.domain.model.mosaicPatternsForColumns
...
import com.diegonmarcos.mediacenter.feature_node.presentation.util.mosaicGridDragHandler
        ...
        when (pattern.companionType) {
            MosaicTilePattern.CompanionType.QUAD -> {
                val big = MosaicDisplayItem.BigTileItem(
                    mediaItem = buffer[0],
                    tileSize = com.diegonmarcos.mediacenter.feature_node.domain.model.BigTileSize.TILE_2x2,
            ...
            MosaicTilePattern.CompanionType.PAIR -> {
                val big = MosaicDisplayItem.BigTileItem(
                    mediaItem = buffer[0],
                    tileSize = com.diegonmarcos.mediacenter.feature_node.domain.model.BigTileSize.TILE_3x2,
                    dynamicSpan = pattern.bigTileSpan,
                    dynamicAspectRatio = pattern.bigTileAspectRatio,
                )
            ...
            MosaicTilePattern.CompanionType.SINGLES -> {
                val big = MosaicDisplayItem.BigTileItem(
                    mediaItem = buffer[0],
                    tileSize = com.diegonmarcos.mediacenter.feature_node.domain.model.BigTileSize.TILE_2x1,
                    dynamicSpan = pattern.bigTileSpan,
                    dynamicAspectRatio = pattern.bigTileAspectRatio,
                )
