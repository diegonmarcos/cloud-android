{
  description = "Cloud-Morpheus — Nix devShell wrapping the Android Gradle build (gradle + AGP + Android SDK + JDK 17). All toolchain pinned; same input → same APK.";
  ...
  outputs = { self, nixpkgs, flake-utils, ... }:
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        #    build.json::toolchain. NO NDK / cmake: morpheus has ZERO native
      ...
      in {
        ...
        devShells.emulator = pkgs.mkShell {
          name = "cloud-morpheus-emulator-devshell";
          buildInputs = with pkgs; [
            jdk17
        ...
        packages.default = pkgs.runCommandLocal "cloud-morpheus-stub" {} ''
          mkdir -p $out
