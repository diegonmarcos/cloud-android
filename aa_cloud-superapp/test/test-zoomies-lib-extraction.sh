...
UNIX="$(cd "$ROOT/.." && pwd)"                    # → ~/git/cloud-u-android
PASS=0; FAIL=0
...
echo "== T7: stray ac_zoomies-pets app folder removed =="
absent "$UNIX/ac_zoomies-pets" "ac_zoomies-pets/ root app folder is gone"
