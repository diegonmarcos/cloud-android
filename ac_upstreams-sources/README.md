...
3. **`ac_cloud-ide/` forks (wrapper)** — same materialize-fork contract as
   ...
   `ac_cloud-ide/build.json::forks.<key>.tracker_dir`). The wrapper bundles the
...
| `editor-acode/` | Acode-Foundation/Acode (MIT) @ v1.12.4 | ide fork `editor` | `ac_cloud-ide/build.sh materialize-fork editor` |
